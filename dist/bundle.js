...
var _addComment = __webpack_require__(28);

var _addComment2 = _interopRequireDefault(_addComment);

var _listComment = __webpack_require__(29);

var _listComment2 = _interopRequireDefault(_listComment);

var _commentsData = __webpack_require__(30);

var _commentsData2 = _interopRequireDefault(_commentsData);
...
var App = function App() {
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            ...
            _commentsData2.default.map(function (comments) {
                return _react2.default.createElement(_listComment2.default, { comment: comments });
            })
        )
    );
};
...
var AddComment = function AddComment() {
    return _react2.default.createElement(
        ...
        _react2.default.createElement("textarea", { placeholder: "descrption" }),
        _react2.default.createElement("br", null),
...
var ListComment = function (_React$Component) {
    _inherits(ListComment, _React$Component);

    function ListComment(props) {
        _classCallCheck(this, ListComment);

        var _this = _possibleConstructorReturn(this, (ListComment.__proto__ || Object.getPrototypeOf(ListComment)).call(this, props));
        ...
        _this.handleSaveEvent = function () {
            _this.setState({
                isEditing: false
            });
        };
            ...
            if (!this.state.isEditing) {
                return _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        "div",
                        null,
                        _react2.default.createElement("input", { type: "button", value: "Edit", onClick: this.handleClickEvent })
                    )
                );
            } else {
                return _react2.default.createElement(
                    ...
                    _react2.default.createElement("textarea", { placeholder: "descrption" }),
                    _react2.default.createElement("br", null),
                    _react2.default.createElement("input", { type: "button", value: "save", onClick: this.handleSaveEvent })
                );
            }
        }
    }]);
...
var commentData = [{ title: "Title 1", desc: "Descrption 1" }, { title: "Title 2", desc: "Descrption 2" }, { title: "Title 3", desc: "Descrption 3" }];
